...
//      psiFile.getText().indexOf("T");
  ...
  private static final String TEST_PACKAGE = "fr.phan.damapping.test.use";
  private static final String OTHER_PACKAGE = "fr.phan.damapping.somepackage.other.deepdown";
  ...
  private void doResolveTestImpl(String fileName, boolean factory) {
    ...
    // create a PsiFile in the package fr.phan.damapping.test.use
