...
/**
 * FunctionIndirectlyImplementedTest -
 *
 * @author lesaint
 */
public class FunctionIndirectlyImplementedTest extends AbstractMapperTest {

  public FunctionIndirectlyImplementedTest() {
    super(FunctionIndirectlyImplemented.class);
  }
