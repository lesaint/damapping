...
/**
 * SubGenerifiedMapperFunction -
 *
 * @author lesaint
 */
public class SubGenerifiedMapperFunctionTest extends AbstractMapperTest {

  public SubGenerifiedMapperFunctionTest() {
    super(SubGenerifiedMapperFunction.class);
  }
