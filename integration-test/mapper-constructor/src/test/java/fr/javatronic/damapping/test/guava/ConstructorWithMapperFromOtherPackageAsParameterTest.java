 ...
 * @author lesaint
 */
public class ConstructorWithMapperFromOtherPackageAsParameterTest extends AbstractMapperTest {

  public ConstructorWithMapperFromOtherPackageAsParameterTest() {
    super(ConstructorWithMapperFromOtherPackageAsParameter.class);
  }
