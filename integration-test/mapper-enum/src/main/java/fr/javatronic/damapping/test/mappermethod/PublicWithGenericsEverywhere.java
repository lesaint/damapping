 ...
 *   <li>support for mapper method with keyword public</li>
 *   <li>support for mapper method with the same name as one of the implicit methds of the Enum type (values)</li>
 * </ul>
 */
@Mapper
