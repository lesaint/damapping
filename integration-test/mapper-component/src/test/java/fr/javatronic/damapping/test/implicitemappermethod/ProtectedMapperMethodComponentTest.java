 ...
 */
public class ProtectedMapperMethodComponentTest extends AbstractMapperTest {
  public ProtectedMapperMethodComponentTest() {
    super(ProtectedMapperMethodComponent.class);
  }
