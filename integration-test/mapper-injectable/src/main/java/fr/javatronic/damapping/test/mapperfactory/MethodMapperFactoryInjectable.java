...
/**
 * MethodMapperFactoryInjectable - Demonstrates use of {@link Injectable} on class annotated with {@link Mapper}
...
@Mapper
@Injectable
public class MethodMapperFactoryInjectable {

  @MapperFactory
  public static MethodMapperFactoryInjectable from(Boolean flag) {
    // implementation does not matter
    return new MethodMapperFactoryInjectable();
  }
