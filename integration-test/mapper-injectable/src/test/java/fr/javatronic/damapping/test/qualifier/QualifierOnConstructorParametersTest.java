...
/**
 * QualifierOnConstructorParametersTest -
 *
 * @author Sébastien Lesaint
 */
public class QualifierOnConstructorParametersTest extends AbstractMapperTest {
  public QualifierOnConstructorParametersTest() {
    super(QualifierOnConstructorParameters.class);
  }
