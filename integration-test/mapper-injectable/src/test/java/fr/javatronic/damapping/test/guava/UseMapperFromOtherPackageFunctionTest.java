...
/**
 * UseMapperFromOtherPackageFunction -
 *
 * @author Sébastien Lesaint
 */
public class UseMapperFromOtherPackageFunctionTest extends AbstractMapperTest {
  public UseMapperFromOtherPackageFunctionTest() {
    super(UseMapperFromOtherPackageFunction.class);
  }
