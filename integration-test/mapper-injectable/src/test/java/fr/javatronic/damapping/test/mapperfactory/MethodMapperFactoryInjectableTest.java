...
/**
 * MethodMapperFactoryInjectable -
 *
 * @author Sébastien Lesaint
 */
public class MethodMapperFactoryInjectableTest extends AbstractMapperTest {
  public MethodMapperFactoryInjectableTest() {
    super(MethodMapperFactoryInjectable.class);
  }
