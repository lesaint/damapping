...
/**
 * StaticMethodWithDependencyTest -
 *
 * @author Sébastien Lesaint
 */
public class StaticMethodWithDependencyTest extends AbstractMapperTest {
  public StaticMethodWithDependencyTest() {
    super(StaticMethodWithDependency.class);
  }
