...
public class DASourceClass implements DAModelVisitable {
    ...
    private DASourceClass(Builder builder) {
        ...
        this.modifiers = builder.getModifiers() == null ? Collections.<DAModifier>emptySet() : ImmutableSet.copyOf(builder.getModifiers());
        this.interfaces = builder.getInterfaces() == null ? Collections.<DAInterface>emptyList() : ImmutableList.copyOf(builder.getInterfaces());
        this.methods = builder.getMethods() == null ? Collections.<DAMethod>emptyList() : ImmutableList.copyOf(builder.getMethods());
        this.enumValues = builder.getEnumValues() == null ? Collections.<DAEnumValue>emptyList() : ImmutableList.copyOf(builder.getEnumValues());
